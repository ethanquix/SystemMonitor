...
#ifndef CPP_GKRELLM_SysinfoMODULE_HPP
#define CPP_GKRELLM_SysinfoMODULE_HPP

#include "AMonitorModule.hpp"

class SysinfoModule : public Modules::AMonitorModule
{
public:
    SysinfoModule();
...
#endif //CPP_GKRELLM_SysinfoMODULE_HPP
